...
class Ship:                                                                                                             #Ship Class starts here
    ...
    def __init__(self, size):                                                                                           #init function to instantiate objects of that class
        ...
        self.size = size                                                                                                #storage for the size of the individual ship
...
class Game:                                                                                                             #Game Class starts here
    def __init__(self):                                                                                                 #init function to instantiate objects of that class
        self.player1 = Player()                                                                                         #player 1 is created as an instance of the player class
        self.player2 = Player()                                                                                         #player 2 is created as an instance of the player class
    ...
    def playerturn(self, i):                                                                                            #method to declare the active and inactive player plus the actual turn of a player
        ...
        if not hit:                                                                                                     #in case no hits have accured...
            self.player1turn = not self.player1turn                                                                     #... the active player is changed by switching from player1_turn to not player1_turn
